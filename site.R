...
page_panel(
  page_section(
    ...
    c(
      '<p class="text-center">State Office of Rural Health</p>',
      paste(
    ...
    c(
      '<p class="text-center">Office of Health Equity</p>',
      '<p class="text-center lead small">- Health Opportunity Index -</p>'
    )
  ),
  conditions = c("", "metric_set == rural_health", "metric_set == hoi"),
  input_select(
    "Metric Set", c("rural_health", "hoi"), 0, c("Rural Health", "Health Equity"),
    id = "metric_set", floating_label = FALSE
  ),
  page_section(
